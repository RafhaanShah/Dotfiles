...
if _colour_true; then
    ...
    typeset -gA ZSH_HIGHLIGHT_STYLES=(
        ['arg0']='fg=#a6e22e,bold'              # green
        ['path']='fg=#66d9ef'                   # blue
        ['dollar-quoted-argument']='fg=#ffd75f' # yellow
        ['double-quoted-argument']='fg=#ffd75f' # yellow
        ['single-quoted-argument']='fg=#ffd75f' # yellow
    )
    ...
    typeset -gA ZSH_HIGHLIGHT_STYLES=(
        ['arg0']='fg=112,bold'              # green
        ['path']='fg=81'                    # cyan
        ['dollar-quoted-argument']='fg=221' # yellow
        ['double-quoted-argument']='fg=221' # yellow
        ['single-quoted-argument']='fg=221' # yellow
    )
else
    ...
    typeset -gA ZSH_HIGHLIGHT_STYLES=(
        ['arg0']='fg=10,bold'              # green
        ['path']='fg=14'                   # cyan
        ['dollar-quoted-argument']='fg=11' # yellow
        ['double-quoted-argument']='fg=11' # yellow
        ['single-quoted-argument']='fg=11' # yellow
    )
fi
